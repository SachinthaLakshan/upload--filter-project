...
const Component = (props) => {
    ...
    const genarateComponentObj = (type) => {
        if (type === "copyright") {
            ...
            return { id: idGenarator(), type: props.type, fileName: imageName, fileUrl: image, editable: false }
        }
        else if (type === "link") {
            return { id: idGenarator(), type: props.type,fileName: imageName, url: linkText, editable: false }
        }
        else if (type === "line") {
